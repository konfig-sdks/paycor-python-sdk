...
class EmployeeSchedule(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            TotalShifts = schemas.Int32Schema
            TotalHours = schemas.Float64Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TotalShifts"]) -> MetaOapg.properties.TotalShifts: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Date", "EmployeeId", "LegalEntityId", "Schedules", "TotalShifts", "TotalHours", "Employee", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TotalShifts"]) -> typing.Union[MetaOapg.properties.TotalShifts, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Date", "EmployeeId", "LegalEntityId", "Schedules", "TotalShifts", "TotalHours", "Employee", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Schedules: typing.Union[MetaOapg.properties.Schedules, list, tuple, None, schemas.Unset] = schemas.unset,
        TotalShifts: typing.Union[MetaOapg.properties.TotalShifts, decimal.Decimal, int, schemas.Unset] = schemas.unset,
