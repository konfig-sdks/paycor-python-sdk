...
class EarningCodeLight(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "LegalEntityId", "TenantId", "Code", "Description", "EffectiveStartDate", "EffectiveEndDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "LegalEntityId", "TenantId", "Code", "Description", "EffectiveStartDate", "EffectiveEndDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        TenantId: typing.Union[MetaOapg.properties.TenantId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
