...
class EmployeeDeductionAmount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Rate", "Amount", "Factor", "EffectiveStartDate", "EffectiveEndDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Rate", "Amount", "Factor", "EffectiveStartDate", "EffectiveEndDate", ], str]):
