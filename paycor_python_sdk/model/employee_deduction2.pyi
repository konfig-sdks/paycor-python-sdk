...
class EmployeeDeduction2(
        ...
        class properties:
            ...
            class AmountData(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmployeeDeductionAmount2']:
                        return EmployeeDeductionAmount2
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Code", "OnHold", "Frequency", "IncludeInPay", "AmountData", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Code", "OnHold", "Frequency", "IncludeInPay", "AmountData", ], str]):
