...
class EmployeeEarningAmount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "Rate", "Amount", "Factor", "EffectiveEndDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "Rate", "Amount", "Factor", "EffectiveEndDate", ], str]):
