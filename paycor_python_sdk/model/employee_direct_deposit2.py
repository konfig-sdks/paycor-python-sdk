...
class EmployeeDirectDeposit2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountType", "Frequency", "OnHold", "AccountNumber", "RoutingNumber", "DeductionCode", "DirectDepositType", "Amount", "Rate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountType", "Frequency", "OnHold", "AccountNumber", "RoutingNumber", "DeductionCode", "DirectDepositType", "Amount", "Rate", ], str]):
