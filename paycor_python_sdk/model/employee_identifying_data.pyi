...
class EmployeeIdentifyingData(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    The PUT EmployeeIdentifyingData model allows updating Employee's personal data fields. 
All fields are required, except EmployeeNumber, Middle Name and Status. 
    ...
    SocialSecurityNumber: MetaOapg.properties.SocialSecurityNumber
    Suffix: 'Suffix'
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FirstName", "LastName", "Suffix", "SocialSecurityNumber", "BirthDate", "MiddleName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Suffix"]) -> 'Suffix': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SocialSecurityNumber"]) -> MetaOapg.properties.SocialSecurityNumber: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FirstName", "LastName", "Suffix", "SocialSecurityNumber", "BirthDate", "MiddleName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        SocialSecurityNumber: typing.Union[MetaOapg.properties.SocialSecurityNumber, str, ],
        Suffix: 'Suffix',
        FirstName: typing.Union[MetaOapg.properties.FirstName, str, ],
        LastName: typing.Union[MetaOapg.properties.LastName, str, ],
        BirthDate: typing.Union[MetaOapg.properties.BirthDate, str, datetime, ],
