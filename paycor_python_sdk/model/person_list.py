...
class PersonList(
    ...
    The Person List model represents general data returned for multiple Persons.
Provides link to additional Person information.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "Prefix", "FirstName", "MiddleName", "LastName", "Suffix", "Person", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "Prefix", "FirstName", "MiddleName", "LastName", "Suffix", "Person", ], str]):
