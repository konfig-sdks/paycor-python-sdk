...
class EmergencyContactData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "FirstName", "MiddleName", "LastName", "Phones", "Order", "Relationship", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "FirstName", "MiddleName", "LastName", "Phones", "Order", "Relationship", ], str]):
