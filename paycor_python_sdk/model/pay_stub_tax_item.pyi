...
class PayStubTaxItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TaxCode", "GlobalTaxCode", "TaxDescription", "TaxAmount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TaxCode", "GlobalTaxCode", "TaxDescription", "TaxAmount", ], str]):
