...
class EmployeeTax2(
    ...
    WithholdingEffectiveStartDate: MetaOapg.properties.WithholdingEffectiveStartDate
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LegalEntityTaxId", "ReciprocityType", "WithholdingEffectiveStartDate", "FilingStatus", "BlockDate", "NonResidentAlien", "IsProbationaryEmployee", "OccupationalCode", "GeographicCode", "SOCCode", "SeasonalCode", "CountyCode", "SpouseWork", "DependentInsuranceEligible", "DependentInsuranceEligibleDate", "ApplicableBirthyear", "AdjustWithholding", "Amount", "Percentage", "NCCICode", "PsdCode", "PsdRate", "OnHold", "Exemptions", "TaxCredit", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReciprocityType"]) -> 'ReciprocityType': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WithholdingEffectiveStartDate"]) -> MetaOapg.properties.WithholdingEffectiveStartDate: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        WithholdingEffectiveStartDate: typing.Union[MetaOapg.properties.WithholdingEffectiveStartDate, str, datetime, ],
