...
class TenantWorkLocation(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    The Tenant Work Location model represents information about Work Locations assigned by the Tenant.
Provides link to the associated Tenant's information.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "Name", "Addresses", "Phones", "Tenant", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "Name", "Addresses", "Phones", "Tenant", ], str]):
