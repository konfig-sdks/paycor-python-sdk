...
class ImpersonatedUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["UserId", "FirstName", "LastName", "LegalEntityId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["UserId", "FirstName", "LastName", "LegalEntityId", ], str]):
