...
class LaborCode(
    ...
    Labor Code (also called Job Code) is used for Job Costing functionality. 
Note that both Category and Code are required in order to be unique. 
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Category", "Code", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Category", "Code", ], str]):
