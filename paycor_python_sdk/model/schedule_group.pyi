...
class ScheduleGroup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "Name", "IsActive", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "Name", "IsActive", ], str]):
