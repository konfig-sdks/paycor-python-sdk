...
class PayStubDeduction(
        ...
        class properties:
            ...
            class Deductions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PayStubDeductionItem']:
                        return PayStubDeductionItem
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TotalDeductionsAmount", "Deductions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TotalDeductionsAmount", "Deductions", ], str]):
