...
class EmployeePayRate2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "SequenceNumber", "Description", "EffectiveEndDate", "PayRate", "AnnualPayRate", "Type", "Reason", "Notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "SequenceNumber", "Description", "EffectiveEndDate", "PayRate", "AnnualPayRate", "Type", "Reason", "Notes", ], str]):
