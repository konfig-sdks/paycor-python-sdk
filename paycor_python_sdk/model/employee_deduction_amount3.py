...
class EmployeeDeductionAmount3(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "Rate", "Amount", "EffectiveEndDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EffectiveStartDate", "Rate", "Amount", "EffectiveEndDate", ], str]):
