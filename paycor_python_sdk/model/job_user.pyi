...
class JobUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "Email", "FirstName", "LastName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "Email", "FirstName", "LastName", ], str]):
