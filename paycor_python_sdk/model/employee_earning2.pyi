...
class EmployeeEarning2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Code", "AmountData", "Frequency", "SequenceNumber", "IncludeInPay", "OnHold", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Code", "AmountData", "Frequency", "SequenceNumber", "IncludeInPay", "OnHold", ], str]):
