...
class EmployeeDirectDeposit3(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "AccountType", "AccountNumber", "RoutingNumber", "Frequency", "OnHold", "DirectDepositType", "Amount", "Rate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "AccountType", "AccountNumber", "RoutingNumber", "Frequency", "OnHold", "DirectDepositType", "Amount", "Rate", ], str]):
