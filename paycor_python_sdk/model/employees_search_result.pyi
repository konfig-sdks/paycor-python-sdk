...
class EmployeesSearchResult(
        ...
        class properties:
            ...
            class Employees(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmployeeRecord']:
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Match", "Employees", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Match", "Employees", ], str]):
