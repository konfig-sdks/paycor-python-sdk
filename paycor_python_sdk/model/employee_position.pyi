...
class EmployeePosition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmploymentType", "WorkLocation", "JobTitle", "Flsa", "ManagerId", "DepartmentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmploymentType", "WorkLocation", "JobTitle", "Flsa", "ManagerId", "DepartmentId", ], str]):
