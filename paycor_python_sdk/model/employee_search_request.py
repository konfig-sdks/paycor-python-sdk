...
class EmployeeSearchRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LegalEntityId", "SocialSecurityNumber", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LegalEntityId", "SocialSecurityNumber", ], str]):
