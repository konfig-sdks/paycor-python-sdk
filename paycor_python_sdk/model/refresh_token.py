...
class RefreshToken(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["refresh_token", "client_id", "client_secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["refresh_token", "client_id", "client_secret", ], str]):
