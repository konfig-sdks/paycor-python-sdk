...
Provides link to the Manager's Employee level information.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "EmployeeNumber", "Employee", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "EmployeeNumber", "Employee", ], str]):
