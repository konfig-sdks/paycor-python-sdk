...
class LegalEntityEarning(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "Code", "GlobalEarningCode", "Description", "Hours", "Amount", "Rate", "Frequency", "IsOnW2", "OnHold", "EffectiveStartDate", "Factor", "LegalEntity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "Code", "GlobalEarningCode", "Description", "Hours", "Amount", "Rate", "Frequency", "IsOnW2", "OnHold", "EffectiveStartDate", "Factor", "LegalEntity", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Hours: typing.Union[MetaOapg.properties.Hours, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ...
        Factor: typing.Union[MetaOapg.properties.Factor, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
