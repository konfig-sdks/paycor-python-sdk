...
class EmployeeTimeCard(
        ...
        class properties:
            ...
            class Details(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TimeCard']:
                        return TimeCard
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmployeeNumber", "BadgeNumber", "Details", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmployeeNumber", "BadgeNumber", "Details", ], str]):
