...
from paycor_python_sdk.model.paged_result_of_employee_time_off_request import PagedResultOfEmployeeTimeOffRequest as PagedResultOfEmployeeTimeOffRequestSchema
...
from paycor_python_sdk.type.paged_result_of_employee_time_off_request import PagedResultOfEmployeeTimeOffRequest

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_employee_time_off_request import PagedResultOfEmployeeTimeOffRequest as PagedResultOfEmployeeTimeOffRequestPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeeTimeOffRequestSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeeTimeOffRequest
...
class BaseApi(api_client.Api):
    ...
    def _list_by_employee_id_mapped_args(
        self,
        employee_id: str,
        start_date: datetime,
        end_date: datetime,
    ...
    async def _alist_by_employee_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/timeoffrequests',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByEmployeeIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_employee_id(
        self,
        employee_id: str,
        start_date: datetime,
        end_date: datetime,
        ...
        **kwargs,
        ...
        args = self._list_by_employee_id_mapped_args(
            employee_id=employee_id,
            start_date=start_date,
            end_date=end_date,
            continuation_token=continuation_token,
        )
        return await self._alist_by_employee_id_oapg(
    ...
    def list_by_employee_id(
        ...
        return self._list_by_employee_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByEmployeeId(BaseApi):
    ...
    async def alist_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeeTimeOffRequestPydantic:
        raw_response = await self.raw.alist_by_employee_id(
            employee_id=employee_id,
            start_date=start_date,
            end_date=end_date,
            continuation_token=continuation_token,
        ...
        if validate:
            return PagedResultOfEmployeeTimeOffRequestPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeeTimeOffRequestPydantic, raw_response.body)
    ...
    def list_by_employee_id(
        ...
        raw_response = self.raw.list_by_employee_id(
            employee_id=employee_id,
            start_date=start_date,
            end_date=end_date,
            continuation_token=continuation_token,
