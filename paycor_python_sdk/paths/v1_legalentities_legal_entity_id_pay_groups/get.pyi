...
from paycor_python_sdk.model.paged_result_of_pay_group import PagedResultOfPayGroup as PagedResultOfPayGroupSchema
...
from paycor_python_sdk.type.paged_result_of_pay_group import PagedResultOfPayGroup

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_pay_group import PagedResultOfPayGroup as PagedResultOfPayGroupPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfPayGroupSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfPayGroup
    ...
    async def _alist_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/payGroups',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByLegalEntityId(BaseApi):
    ...
    async def alist_by_legal_entity_id(
        ...
        **kwargs,
        ...
        if validate:
            return PagedResultOfPayGroupPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfPayGroupPydantic, raw_response.body)
