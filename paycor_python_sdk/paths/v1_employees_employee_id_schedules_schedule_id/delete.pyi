...
ScheduleIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'employeeId': typing.Union[EmployeeIdSchema, str, ],
        'scheduleId': typing.Union[ScheduleIdSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _delete_legacy_schedule_mapped_args(
        self,
        employee_id: str,
        schedule_id: str,
    ...
    async def _adelete_legacy_schedule_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/schedules/{scheduleId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _delete_legacy_schedule_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteLegacyScheduleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_legacy_schedule(
        self,
        employee_id: str,
        schedule_id: str,
        **kwargs,
        ...
        args = self._delete_legacy_schedule_mapped_args(
            employee_id=employee_id,
            schedule_id=schedule_id,
        )
        return await self._adelete_legacy_schedule_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_legacy_schedule(
        self,
        employee_id: str,
        schedule_id: str,
    ) -> typing.Union[
        ...
        return self._delete_legacy_schedule_oapg(
            path_params=args.path,
        )

class DeleteLegacySchedule(BaseApi):
    ...
    async def adelete_legacy_schedule(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_legacy_schedule(
            employee_id=employee_id,
            schedule_id=schedule_id,
            **kwargs,
        )
    ...
    def delete_legacy_schedule(
        ...
        raw_response = self.raw.delete_legacy_schedule(
            employee_id=employee_id,
            schedule_id=schedule_id,
        )
