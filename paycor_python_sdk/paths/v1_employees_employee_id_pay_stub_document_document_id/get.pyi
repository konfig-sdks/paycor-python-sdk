...
class BaseApi(api_client.Api):
    ...
    def _download_pay_stub_mapped_args(
        self,
        employee_id: str,
        document_id: str,
    ...
    async def _adownload_pay_stub_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/PayStubDocument/{documentId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DownloadPayStubRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_pay_stub(
        self,
        employee_id: str,
        document_id: str,
        **kwargs,
        ...
        args = self._download_pay_stub_mapped_args(
            employee_id=employee_id,
            document_id=document_id,
        )
        return await self._adownload_pay_stub_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def download_pay_stub(
        self,
        employee_id: str,
        document_id: str,
    ) -> typing.Union[
        ...
        return self._download_pay_stub_oapg(
            path_params=args.path,
        )

class DownloadPayStub(BaseApi):
    ...
    async def adownload_pay_stub(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_pay_stub(
            employee_id=employee_id,
            document_id=document_id,
            **kwargs,
        )
    ...
    def download_pay_stub(
        ...
        raw_response = self.raw.download_pay_stub(
            employee_id=employee_id,
            document_id=document_id,
        )
        if validate:
