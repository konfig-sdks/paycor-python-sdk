...
from paycor_python_sdk.model.paged_result_of_labor_categories import PagedResultOfLaborCategories as PagedResultOfLaborCategoriesSchema
...
from paycor_python_sdk.type.paged_result_of_labor_categories import PagedResultOfLaborCategories

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.paged_result_of_labor_categories import PagedResultOfLaborCategories as PagedResultOfLaborCategoriesPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfLaborCategoriesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfLaborCategories
...
class BaseApi(api_client.Api):
    ...
    def _by_legal_entity_id_get_mapped_args(
        self,
        legal_entity_id: int,
    ...
    async def _aby_legal_entity_id_get_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/laborcategories',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _by_legal_entity_id_get_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ByLegalEntityIdGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aby_legal_entity_id_get(
        self,
        legal_entity_id: int,
        continuation_token: typing.Optional[typing.Optional[str]] = None,
        **kwargs,
        ...
        args = self._by_legal_entity_id_get_mapped_args(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        return await self._aby_legal_entity_id_get_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def by_legal_entity_id_get(
        self,
        legal_entity_id: int,
        continuation_token: typing.Optional[typing.Optional[str]] = None,
    ) -> typing.Union[
        ...
        return self._by_legal_entity_id_get_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ByLegalEntityIdGet(BaseApi):
    ...
    async def aby_legal_entity_id_get(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfLaborCategoriesPydantic:
        raw_response = await self.raw.aby_legal_entity_id_get(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
            **kwargs,
        )
        if validate:
            return PagedResultOfLaborCategoriesPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfLaborCategoriesPydantic, raw_response.body)
    ...
    def by_legal_entity_id_get(
        ...
        raw_response = self.raw.by_legal_entity_id_get(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        if validate:
