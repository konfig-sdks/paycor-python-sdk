...
from paycor_python_sdk.model.paged_result_of_person_list import PagedResultOfPersonList as PagedResultOfPersonListSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.paged_result_of_person_list import PagedResultOfPersonList
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_person_list import PagedResultOfPersonList as PagedResultOfPersonListPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfPersonListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfPersonList
    ...
    async def _alist_by_tenant_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tenants/{tenantId}/persons',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByTenantId(BaseApi):
    ...
    async def alist_by_tenant_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfPersonListPydantic:
        ...
        if validate:
            return PagedResultOfPersonListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfPersonListPydantic, raw_response.body)
