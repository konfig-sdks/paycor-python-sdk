...
from paycor_python_sdk.model.paged_result_of_legal_entity_work_location import PagedResultOfLegalEntityWorkLocation as PagedResultOfLegalEntityWorkLocationSchema

from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.paged_result_of_legal_entity_work_location import PagedResultOfLegalEntityWorkLocation

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_legal_entity_work_location import PagedResultOfLegalEntityWorkLocation as PagedResultOfLegalEntityWorkLocationPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfLegalEntityWorkLocationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfLegalEntityWorkLocation
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfLegalEntityWorkLocationPydantic:
        ...
        if validate:
            return PagedResultOfLegalEntityWorkLocationPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfLegalEntityWorkLocationPydantic, raw_response.body)
