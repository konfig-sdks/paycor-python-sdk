...
from paycor_python_sdk.model.employee_custom_fields_get_by_employee_id_response import EmployeeCustomFieldsGetByEmployeeIdResponse as EmployeeCustomFieldsGetByEmployeeIdResponseSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.employee_custom_fields_get_by_employee_id_response import EmployeeCustomFieldsGetByEmployeeIdResponse
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.employee_custom_fields_get_by_employee_id_response import EmployeeCustomFieldsGetByEmployeeIdResponse as EmployeeCustomFieldsGetByEmployeeIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeCustomFieldsGetByEmployeeIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeCustomFieldsGetByEmployeeIdResponse
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeCustomFieldsGetByEmployeeIdResponsePydantic:
        ...
        if validate:
            return RootModel[EmployeeCustomFieldsGetByEmployeeIdResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EmployeeCustomFieldsGetByEmployeeIdResponsePydantic, raw_response.body)
