...
from paycor_python_sdk.model.paged_result_of_work_site import PagedResultOfWorkSite as PagedResultOfWorkSiteSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.paged_result_of_work_site import PagedResultOfWorkSite
...
from paycor_python_sdk.pydantic.paged_result_of_work_site import PagedResultOfWorkSite as PagedResultOfWorkSitePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfWorkSiteSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfWorkSite
    ...
    async def _aget_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/worksites',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByLegalEntityId(BaseApi):
    ...
    async def aget_by_legal_entity_id(
        ...
        **kwargs,
        ...
        if validate:
            return PagedResultOfWorkSitePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfWorkSitePydantic, raw_response.body)
