...
from paycor_python_sdk.model.includes9 import Includes9 as Includes9Schema
from paycor_python_sdk.model.paged_result_of_pay_stub import PagedResultOfPayStub as PagedResultOfPayStubSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.paged_result_of_pay_stub import PagedResultOfPayStub
from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.includes9 import Includes9

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.includes9 import Includes9 as Includes9Pydantic
from paycor_python_sdk.pydantic.paged_result_of_pay_stub import PagedResultOfPayStub as PagedResultOfPayStubPydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Includes9']:
            return Includes9
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfPayStubSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfPayStub
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_mapped_args(
        ...
        include: typing.Optional[typing.Optional[typing.List[Includes9]]] = None,
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/paystubs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        **kwargs,
        ...
        if validate:
            return PagedResultOfPayStubPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfPayStubPydantic, raw_response.body)
