...
from paycor_python_sdk.model.paged_result_of_tenant_job_title import PagedResultOfTenantJobTitle as PagedResultOfTenantJobTitleSchema
...
from paycor_python_sdk.type.paged_result_of_tenant_job_title import PagedResultOfTenantJobTitle

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_tenant_job_title import PagedResultOfTenantJobTitle as PagedResultOfTenantJobTitlePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfTenantJobTitleSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfTenantJobTitle
    ...
    async def _alist_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/jobtitles',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByLegalEntityId(BaseApi):
    ...
    async def alist_by_legal_entity_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfTenantJobTitlePydantic:
        ...
        if validate:
            return PagedResultOfTenantJobTitlePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfTenantJobTitlePydantic, raw_response.body)
