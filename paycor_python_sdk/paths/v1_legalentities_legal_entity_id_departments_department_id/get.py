...
from paycor_python_sdk.model.department import Department as DepartmentSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.department import Department
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.department import Department as DepartmentPydantic
...
SchemaFor200ResponseBodyApplicationJson = DepartmentSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/departments/{departmentId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return DepartmentPydantic(**raw_response.body)
        return api_client.construct_model_instance(DepartmentPydantic, raw_response.body)
