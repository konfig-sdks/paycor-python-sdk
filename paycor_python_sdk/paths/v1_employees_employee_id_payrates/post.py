...
from paycor_python_sdk.model.employee_pay_rate2 import EmployeePayRate2 as EmployeePayRate2Schema
...
from paycor_python_sdk.type.employee_pay_rate2 import EmployeePayRate2
...
from paycor_python_sdk.pydantic.employee_pay_rate2 import EmployeePayRate2 as EmployeePayRate2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeePayRate2Schema


request_body_employee_pay_rate2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_new_rate_mapped_args(
        ...
        pay_rate: typing.Optional[typing.Optional[typing.Union[int, float]]] = None,
    ...
    async def _aadd_new_rate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/payrates',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_pay_rate2.serialize(body, content_type)
...
class AddNewRateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_rate(
        self,
        effective_start_date: datetime,
        sequence_number: int,
        description: str,
        ...
        **kwargs,
        ...
        args = self._add_new_rate_mapped_args(
        ...
        return await self._aadd_new_rate_oapg(
            body=args.body,
    ...
    def add_new_rate(
        ...
        return self._add_new_rate_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewRate(BaseApi):
    ...
    async def aadd_new_rate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_rate(
            effective_start_date=effective_start_date,
            sequence_number=sequence_number,
            description=description,
            employee_id=employee_id,
    ...
    def add_new_rate(
        ...
        raw_response = self.raw.add_new_rate(
            effective_start_date=effective_start_date,
            sequence_number=sequence_number,
            description=description,
            employee_id=employee_id,
