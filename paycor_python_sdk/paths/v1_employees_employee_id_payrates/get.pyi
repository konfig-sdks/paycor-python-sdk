...
from paycor_python_sdk.model.paged_result_of_employee_pay_rate import PagedResultOfEmployeePayRate as PagedResultOfEmployeePayRateSchema
...
from paycor_python_sdk.type.paged_result_of_employee_pay_rate import PagedResultOfEmployeePayRate

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_employee_pay_rate import PagedResultOfEmployeePayRate as PagedResultOfEmployeePayRatePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeePayRateSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeePayRate
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeePayRatePydantic:
        ...
        if validate:
            return PagedResultOfEmployeePayRatePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeePayRatePydantic, raw_response.body)
