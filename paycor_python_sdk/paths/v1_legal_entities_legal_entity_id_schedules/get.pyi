...
from paycor_python_sdk.model.paged_result_of_employee_schedule import PagedResultOfEmployeeSchedule as PagedResultOfEmployeeScheduleSchema

from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.paged_result_of_employee_schedule import PagedResultOfEmployeeSchedule

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.paged_result_of_employee_schedule import PagedResultOfEmployeeSchedule as PagedResultOfEmployeeSchedulePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeeScheduleSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeeSchedule
    ...
    async def _aget_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalEntities/{legalEntityId}/schedules',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByLegalEntityId(BaseApi):
    ...
    async def aget_by_legal_entity_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeeSchedulePydantic:
        ...
        if validate:
            return PagedResultOfEmployeeSchedulePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeeSchedulePydantic, raw_response.body)
