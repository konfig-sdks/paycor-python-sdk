...
from paycor_python_sdk.model.certification import Certification as CertificationSchema

from paycor_python_sdk.type.certification import Certification
...
from paycor_python_sdk.pydantic.certification import Certification as CertificationPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CertificationSchema


request_body_certification = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _add_new_certification_mapped_args(
        self,
        certification_name: str,
        employee_id: str,
        effective_date: typing.Optional[typing.Optional[datetime]] = None,
        expiration_date: typing.Optional[typing.Optional[datetime]] = None,
        certification_number: typing.Optional[typing.Optional[str]] = None,
        certification_organization_name: typing.Optional[typing.Optional[str]] = None,
        ...
        if certification_name is not None:
            _body["CertificationName"] = certification_name
        if certification_number is not None:
            _body["CertificationNumber"] = certification_number
        if certification_organization_name is not None:
            _body["CertificationOrganizationName"] = certification_organization_name
    ...
    async def _aadd_new_certification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/certifications',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_certification.serialize(body, content_type)
    ...
    def _add_new_certification_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddNewCertificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_certification(
        self,
        certification_name: str,
        employee_id: str,
        effective_date: typing.Optional[typing.Optional[datetime]] = None,
        ...
        **kwargs,
        ...
        args = self._add_new_certification_mapped_args(
        ...
        return await self._aadd_new_certification_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_new_certification(
        self,
        certification_name: str,
        employee_id: str,
        effective_date: typing.Optional[typing.Optional[datetime]] = None,
        ...
        return self._add_new_certification_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewCertification(BaseApi):
    ...
    async def aadd_new_certification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_certification(
            certification_name=certification_name,
            employee_id=employee_id,
            effective_date=effective_date,
            expiration_date=expiration_date,
    ...
    def add_new_certification(
        ...
        raw_response = self.raw.add_new_certification(
            certification_name=certification_name,
            employee_id=employee_id,
            effective_date=effective_date,
            expiration_date=expiration_date,
