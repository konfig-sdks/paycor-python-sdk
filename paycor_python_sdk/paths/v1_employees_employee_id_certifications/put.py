...
from paycor_python_sdk.model.employee_certification2 import EmployeeCertification2 as EmployeeCertification2Schema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.employee_certification2 import EmployeeCertification2
...
from paycor_python_sdk.pydantic.employee_certification2 import EmployeeCertification2 as EmployeeCertification2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeCertification2Schema


request_body_employee_certification2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_certification_mapped_args(
        self,
        employee_certification_id: str,
        employee_id: str,
        ...
        if employee_certification_id is not None:
            _body["EmployeeCertificationId"] = employee_certification_id
    ...
    async def _aupdate_certification_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_employee_certification2.serialize(body, content_type)
    ...
    def _update_certification_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateCertificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_certification(
        self,
        employee_certification_id: str,
        employee_id: str,
        certification_number: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._update_certification_mapped_args(
        ...
        return await self._aupdate_certification_oapg(
            body=args.body,
    ...
    def update_certification(
        ...
        return self._update_certification_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateCertification(BaseApi):
    ...
    async def aupdate_certification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_certification(
            employee_certification_id=employee_certification_id,
            employee_id=employee_id,
            certification_number=certification_number,
            effective_date=effective_date,
    ...
    def update_certification(
        ...
        raw_response = self.raw.update_certification(
            employee_certification_id=employee_certification_id,
            employee_id=employee_id,
            certification_number=certification_number,
            effective_date=effective_date,
