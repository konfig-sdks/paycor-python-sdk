...
from paycor_python_sdk.model.paged_result_of_schedule_group import PagedResultOfScheduleGroup as PagedResultOfScheduleGroupSchema

from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.paged_result_of_schedule_group import PagedResultOfScheduleGroup

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_schedule_group import PagedResultOfScheduleGroup as PagedResultOfScheduleGroupPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfScheduleGroupSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfScheduleGroup
    ...
    async def _aget_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/schedulegroups',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByLegalEntityId(BaseApi):
    ...
    async def aget_by_legal_entity_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfScheduleGroupPydantic:
        ...
        if validate:
            return PagedResultOfScheduleGroupPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfScheduleGroupPydantic, raw_response.body)
