...
class BaseApi(api_client.Api):
    ...
    def _update_paygroup_mapped_args(
        self,
        employee_id: str,
    ...
    async def _aupdate_paygroup_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/Paygroup',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UpdatePaygroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_paygroup(
        self,
        employee_id: str,
        pay_group_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_paygroup_mapped_args(
            employee_id=employee_id,
            pay_group_id=pay_group_id,
        )
        return await self._aupdate_paygroup_oapg(
    ...
    def update_paygroup(
        ...
        return self._update_paygroup_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class UpdatePaygroup(BaseApi):
    ...
    async def aupdate_paygroup(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_paygroup(
            employee_id=employee_id,
            pay_group_id=pay_group_id,
            **kwargs,
        )
    ...
    def update_paygroup(
        ...
        raw_response = self.raw.update_paygroup(
            employee_id=employee_id,
            pay_group_id=pay_group_id,
        )
        if validate:
