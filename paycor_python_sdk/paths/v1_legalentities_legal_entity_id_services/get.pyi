...
from paycor_python_sdk.model.services import Services as ServicesSchema

from paycor_python_sdk.type.services import Services
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.services import Services as ServicesPydantic
...
SchemaFor200ResponseBodyApplicationJson = ServicesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_subscribed_services_mapped_args(
        self,
        legal_entity_id: int,
    ...
    async def _aget_subscribed_services_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/services',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_subscribed_services_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSubscribedServicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_subscribed_services(
        self,
        legal_entity_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_subscribed_services_mapped_args(
            legal_entity_id=legal_entity_id,
        )
        return await self._aget_subscribed_services_oapg(
    ...
    def get_subscribed_services(
        ...
        return self._get_subscribed_services_oapg(
            path_params=args.path,
        )

class GetSubscribedServices(BaseApi):
    ...
    async def aget_subscribed_services(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_subscribed_services(
            legal_entity_id=legal_entity_id,
            **kwargs,
        )
        if validate:
            return ServicesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ServicesPydantic, raw_response.body)
    ...
    def get_subscribed_services(
        ...
        raw_response = self.raw.get_subscribed_services(
            legal_entity_id=legal_entity_id,
        )
        if validate:
            return ServicesPydantic(**raw_response.body)
