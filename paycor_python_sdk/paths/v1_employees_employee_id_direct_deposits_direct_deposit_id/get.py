...
from paycor_python_sdk.model.employee_direct_deposit import EmployeeDirectDeposit as EmployeeDirectDepositSchema
...
from paycor_python_sdk.type.employee_direct_deposit import EmployeeDirectDeposit

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.employee_direct_deposit import EmployeeDirectDeposit as EmployeeDirectDepositPydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeDirectDepositSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeeDirectDeposit
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_and_deposit_id_mapped_args(
        self,
        employee_id: str,
    ...
    async def _aget_by_employee_and_deposit_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/DirectDeposits/{directDepositId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_by_employee_and_deposit_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByEmployeeAndDepositIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_employee_and_deposit_id(
        self,
        employee_id: str,
        direct_deposit_id: str,
        **kwargs,
        ...
        args = self._get_by_employee_and_deposit_id_mapped_args(
            employee_id=employee_id,
            direct_deposit_id=direct_deposit_id,
        )
        return await self._aget_by_employee_and_deposit_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_employee_and_deposit_id(
        self,
        employee_id: str,
        direct_deposit_id: str,
    ) -> typing.Union[
        ...
        return self._get_by_employee_and_deposit_id_oapg(
            path_params=args.path,
        )

class GetByEmployeeAndDepositId(BaseApi):
    ...
    async def aget_by_employee_and_deposit_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeDirectDepositPydantic:
        raw_response = await self.raw.aget_by_employee_and_deposit_id(
            employee_id=employee_id,
            direct_deposit_id=direct_deposit_id,
            **kwargs,
        )
        if validate:
            return EmployeeDirectDepositPydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeDirectDepositPydantic, raw_response.body)
    ...
    def get_by_employee_and_deposit_id(
        ...
        raw_response = self.raw.get_by_employee_and_deposit_id(
            employee_id=employee_id,
            direct_deposit_id=direct_deposit_id,
        )
        if validate:
