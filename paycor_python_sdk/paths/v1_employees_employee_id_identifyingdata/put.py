...
from paycor_python_sdk.model.employee_identifying_data import EmployeeIdentifyingData as EmployeeIdentifyingDataSchema
...
from paycor_python_sdk.type.employee_identifying_data import EmployeeIdentifyingData

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.employee_identifying_data import EmployeeIdentifyingData as EmployeeIdentifyingDataPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeIdentifyingDataSchema


request_body_employee_identifying_data = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_personal_data_mapped_args(
        self,
        first_name: str,
        last_name: str,
        suffix: Suffix,
    ...
    async def _aupdate_personal_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/identifyingdata',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_identifying_data.serialize(body, content_type)
    ...
    def _update_personal_data_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdatePersonalDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_personal_data(
        self,
        first_name: str,
        last_name: str,
        suffix: Suffix,
        ...
        **kwargs,
        ...
        args = self._update_personal_data_mapped_args(
        ...
        return await self._aupdate_personal_data_oapg(
            body=args.body,
    ...
    def update_personal_data(
        ...
        return self._update_personal_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdatePersonalData(BaseApi):
    ...
    async def aupdate_personal_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_personal_data(
            first_name=first_name,
            last_name=last_name,
            suffix=suffix,
            social_security_number=social_security_number,
    ...
    def update_personal_data(
        ...
        raw_response = self.raw.update_personal_data(
            first_name=first_name,
            last_name=last_name,
            suffix=suffix,
            social_security_number=social_security_number,
