...
from paycor_python_sdk.model.paged_result_of_person import PagedResultOfPerson as PagedResultOfPersonSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema
from paycor_python_sdk.model.includes_list import IncludesList as IncludesListSchema

from paycor_python_sdk.type.includes_list import IncludesList
from paycor_python_sdk.type.paged_result_of_person import PagedResultOfPerson
...
from paycor_python_sdk.pydantic.paged_result_of_person import PagedResultOfPerson as PagedResultOfPersonPydantic
from paycor_python_sdk.pydantic.includes_list import IncludesList as IncludesListPydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['IncludesList']:
            return IncludesList
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfPersonSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfPerson
...
class BaseApi(api_client.Api):
    ...
    def _list_by_legal_entity_id_mapped_args(
        self,
        legal_entity_id: int,
        include: typing.Optional[typing.Optional[typing.List[IncludesList]]] = None,
    ...
    async def _alist_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalEntities/{legalEntityId}/persons',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByLegalEntityId(BaseApi):
    ...
    async def alist_by_legal_entity_id(
        ...
        **kwargs,
        ...
        if validate:
            return PagedResultOfPersonPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfPersonPydantic, raw_response.body)
