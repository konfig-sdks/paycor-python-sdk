...
from paycor_python_sdk.model.tenant_certification import TenantCertification as TenantCertificationSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.tenant_certification import TenantCertification
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.tenant_certification import TenantCertification as TenantCertificationPydantic
...
SchemaFor200ResponseBodyApplicationJson = TenantCertificationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TenantCertification
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/certifications',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return TenantCertificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(TenantCertificationPydantic, raw_response.body)
