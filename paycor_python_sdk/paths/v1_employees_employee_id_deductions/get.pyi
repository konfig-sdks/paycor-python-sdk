...
from paycor_python_sdk.model.paged_result_of_employee_deduction import PagedResultOfEmployeeDeduction as PagedResultOfEmployeeDeductionSchema
from paycor_python_sdk.model.includes4 import Includes4 as Includes4Schema

from paycor_python_sdk.type.paged_result_of_employee_deduction import PagedResultOfEmployeeDeduction
from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.includes4 import Includes4

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_employee_deduction import PagedResultOfEmployeeDeduction as PagedResultOfEmployeeDeductionPydantic
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.includes4 import Includes4 as Includes4Pydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Includes4']:
            return Includes4
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeeDeductionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeeDeduction
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_mapped_args(
        self,
        employee_id: str,
        include: typing.Optional[typing.Optional[typing.List[Includes4]]] = None,
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeeDeductionPydantic:
        ...
        if validate:
            return PagedResultOfEmployeeDeductionPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeeDeductionPydantic, raw_response.body)
