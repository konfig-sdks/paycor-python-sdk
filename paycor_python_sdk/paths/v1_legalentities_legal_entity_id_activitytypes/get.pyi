...
from paycor_python_sdk.model.paged_result_of_activity_type import PagedResultOfActivityType as PagedResultOfActivityTypeSchema

from paycor_python_sdk.type.paycor_error import PaycorError
from paycor_python_sdk.type.paged_result_of_activity_type import PagedResultOfActivityType

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.paged_result_of_activity_type import PagedResultOfActivityType as PagedResultOfActivityTypePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfActivityTypeSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfActivityType
    ...
    async def _aget_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/activitytypes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByLegalEntityId(BaseApi):
    ...
    async def aget_by_legal_entity_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfActivityTypePydantic:
        ...
        if validate:
            return PagedResultOfActivityTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfActivityTypePydantic, raw_response.body)
