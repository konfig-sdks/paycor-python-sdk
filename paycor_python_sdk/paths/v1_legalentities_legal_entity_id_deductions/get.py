...
from paycor_python_sdk.model.paged_result_of_legal_entity_deduction import PagedResultOfLegalEntityDeduction as PagedResultOfLegalEntityDeductionSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.paged_result_of_legal_entity_deduction import PagedResultOfLegalEntityDeduction
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_legal_entity_deduction import PagedResultOfLegalEntityDeduction as PagedResultOfLegalEntityDeductionPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfLegalEntityDeductionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfLegalEntityDeduction
...
class BaseApi(api_client.Api):
    ...
    def _view_employees_data_mapped_args(
        self,
        legal_entity_id: int,
    ...
    async def _aview_employees_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/deductions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ViewEmployeesDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aview_employees_data(
        self,
        legal_entity_id: int,
        continuation_token: typing.Optional[typing.Optional[str]] = None,
        **kwargs,
        ...
        args = self._view_employees_data_mapped_args(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        return await self._aview_employees_data_oapg(
    ...
    def view_employees_data(
        ...
        return self._view_employees_data_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ViewEmployeesData(BaseApi):
    ...
    async def aview_employees_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfLegalEntityDeductionPydantic:
        raw_response = await self.raw.aview_employees_data(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
            **kwargs,
        )
        if validate:
            return PagedResultOfLegalEntityDeductionPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfLegalEntityDeductionPydantic, raw_response.body)
    ...
    def view_employees_data(
        ...
        raw_response = self.raw.view_employees_data(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        if validate:
