...
from paycor_python_sdk.model.includes6 import Includes6 as Includes6Schema
from paycor_python_sdk.model.paged_result_of_employee_earning import PagedResultOfEmployeeEarning as PagedResultOfEmployeeEarningSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.includes6 import Includes6
from paycor_python_sdk.type.paged_result_of_employee_earning import PagedResultOfEmployeeEarning
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paged_result_of_employee_earning import PagedResultOfEmployeeEarning as PagedResultOfEmployeeEarningPydantic
from paycor_python_sdk.pydantic.includes6 import Includes6 as Includes6Pydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Includes6']:
            return Includes6
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeeEarningSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeeEarning
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_mapped_args(
        self,
        employee_id: str,
        include: typing.Optional[typing.Optional[typing.List[Includes6]]] = None,
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeeEarningPydantic:
        ...
        if validate:
            return PagedResultOfEmployeeEarningPydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeeEarningPydantic, raw_response.body)
