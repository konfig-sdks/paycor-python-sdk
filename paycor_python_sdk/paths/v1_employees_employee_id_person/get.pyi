...
from paycor_python_sdk.model.includes21 import Includes21 as Includes21Schema
...
from paycor_python_sdk.type.includes21 import Includes21

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.includes21 import Includes21 as Includes21Pydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Includes21']:
            return Includes21
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_person_mapped_args(
        self,
        employee_id: str,
        include: typing.Optional[typing.Optional[typing.List[Includes21]]] = None,
    ...
    async def _aget_by_employee_id_person_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/person',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_by_employee_id_person_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetByEmployeeIdPersonRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_employee_id_person(
        self,
        employee_id: str,
        include: typing.Optional[typing.Optional[typing.List[Includes21]]] = None,
        **kwargs,
        ...
        args = self._get_by_employee_id_person_mapped_args(
            employee_id=employee_id,
            include=include,
        )
        return await self._aget_by_employee_id_person_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_employee_id_person(
        self,
        employee_id: str,
        include: typing.Optional[typing.Optional[typing.List[Includes21]]] = None,
    ) -> typing.Union[
        ...
        return self._get_by_employee_id_person_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByEmployeeIdPerson(BaseApi):
    ...
    async def aget_by_employee_id_person(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_employee_id_person(
            employee_id=employee_id,
            include=include,
            **kwargs,
        )
    ...
    def get_by_employee_id_person(
        ...
        raw_response = self.raw.get_by_employee_id_person(
            employee_id=employee_id,
            include=include,
        )
        if validate:
