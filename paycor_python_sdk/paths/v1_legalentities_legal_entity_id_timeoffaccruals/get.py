...
from paycor_python_sdk.model.paged_result_of_employee_balance import PagedResultOfEmployeeBalance as PagedResultOfEmployeeBalanceSchema
...
from paycor_python_sdk.type.paged_result_of_employee_balance import PagedResultOfEmployeeBalance

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.paged_result_of_employee_balance import PagedResultOfEmployeeBalance as PagedResultOfEmployeeBalancePydantic
...
SchemaFor200ResponseBodyApplicationJson = PagedResultOfEmployeeBalanceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagedResultOfEmployeeBalance
    ...
    async def _aget_by_legal_entity_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}/timeoffaccruals',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByLegalEntityId(BaseApi):
    ...
    async def aget_by_legal_entity_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagedResultOfEmployeeBalancePydantic:
        ...
        if validate:
            return PagedResultOfEmployeeBalancePydantic(**raw_response.body)
        return api_client.construct_model_instance(PagedResultOfEmployeeBalancePydantic, raw_response.body)
