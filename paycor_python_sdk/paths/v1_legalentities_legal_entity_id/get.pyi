...
from paycor_python_sdk.model.includes19 import Includes19 as Includes19Schema
from paycor_python_sdk.model.legal_entity import LegalEntity as LegalEntitySchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema

from paycor_python_sdk.type.includes19 import Includes19
from paycor_python_sdk.type.legal_entity import LegalEntity
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.legal_entity import LegalEntity as LegalEntityPydantic
from paycor_python_sdk.pydantic.includes19 import Includes19 as Includes19Pydantic
...
class IncludeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Includes19']:
            return Includes19
...
SchemaFor200ResponseBodyApplicationJson = LegalEntitySchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        self,
        legal_entity_id: int,
        include: typing.Optional[typing.Optional[typing.List[Includes19]]] = None,
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalentities/{legalEntityId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return LegalEntityPydantic(**raw_response.body)
        return api_client.construct_model_instance(LegalEntityPydantic, raw_response.body)
