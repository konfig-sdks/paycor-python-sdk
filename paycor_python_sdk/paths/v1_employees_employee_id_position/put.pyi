...
from paycor_python_sdk.model.employee_position import EmployeePosition as EmployeePositionSchema

from paycor_python_sdk.type.flsa_type import FlsaType
from paycor_python_sdk.type.employee_position import EmployeePosition
...
from paycor_python_sdk.pydantic.employee_position import EmployeePosition as EmployeePositionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeePositionSchema


request_body_employee_position = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_position_data_mapped_args(
        self,
    ...
    async def _aupdate_position_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/position',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_position.serialize(body, content_type)
    ...
    def _update_position_data_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdatePositionDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_position_data(
        self,
        employment_type: EmploymentType,
        work_location: str,
        employee_id: str,
        ...
        **kwargs,
        ...
        args = self._update_position_data_mapped_args(
        ...
        return await self._aupdate_position_data_oapg(
            body=args.body,
    ...
    def update_position_data(
        ...
        return self._update_position_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdatePositionData(BaseApi):
    ...
    async def aupdate_position_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_position_data(
            employment_type=employment_type,
            work_location=work_location,
            employee_id=employee_id,
            job_title=job_title,
    ...
    def update_position_data(
        ...
        raw_response = self.raw.update_position_data(
            employment_type=employment_type,
            work_location=work_location,
            employee_id=employee_id,
            job_title=job_title,
