...
from paycor_python_sdk.model.emergency_contact import EmergencyContact as EmergencyContactSchema
from paycor_python_sdk.model.paycor_error import PaycorError as PaycorErrorSchema
from paycor_python_sdk.model.relationship import Relationship as RelationshipSchema

from paycor_python_sdk.type.emergency_contact import EmergencyContact
...
from paycor_python_sdk.type.relationship import Relationship

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.emergency_contact import EmergencyContact as EmergencyContactPydantic
...
from paycor_python_sdk.pydantic.relationship import Relationship as RelationshipPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmergencyContactSchema


request_body_emergency_contact = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_update_mapped_args(
        ...
        if work_phone_extension is not None:
            _body["WorkPhoneExtension"] = work_phone_extension
    ...
    async def _acreate_update_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/emergencycontact',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_emergency_contact.serialize(body, content_type)
...
class CreateUpdateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_update(
        self,
        first_name: str,
        last_name: str,
        employee_id: str,
        ...
        **kwargs,
        ...
        args = self._create_update_mapped_args(
        ...
        return await self._acreate_update_oapg(
            body=args.body,
    ...
    def create_update(
        ...
        return self._create_update_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateUpdate(BaseApi):
    ...
    async def acreate_update(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_update(
            first_name=first_name,
            last_name=last_name,
            employee_id=employee_id,
            middle_name=middle_name,
    ...
    def create_update(
        ...
        raw_response = self.raw.create_update(
            first_name=first_name,
            last_name=last_name,
            employee_id=employee_id,
            middle_name=middle_name,
