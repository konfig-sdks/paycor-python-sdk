...
from paycor_python_sdk.model.ats_account import ATSAccount as ATSAccountSchema
...
from paycor_python_sdk.type.ats_account import ATSAccount

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.ats_account import ATSAccount as ATSAccountPydantic
...
SchemaFor200ResponseBodyApplicationJson = ATSAccountSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_ats_accounts_by_legal_entity_mapped_args(
        self,
        legal_entity_id: int,
    ...
    async def _alist_ats_accounts_by_legal_entity_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/legalEntities/{legalEntityId}/ats/accounts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_ats_accounts_by_legal_entity_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListAtsAccountsByLegalEntityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_ats_accounts_by_legal_entity(
        self,
        legal_entity_id: int,
        continuation_token: typing.Optional[typing.Optional[str]] = None,
        **kwargs,
        ...
        args = self._list_ats_accounts_by_legal_entity_mapped_args(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        return await self._alist_ats_accounts_by_legal_entity_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_ats_accounts_by_legal_entity(
        self,
        legal_entity_id: int,
        continuation_token: typing.Optional[typing.Optional[str]] = None,
    ) -> typing.Union[
        ...
        return self._list_ats_accounts_by_legal_entity_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListAtsAccountsByLegalEntity(BaseApi):
    ...
    async def alist_ats_accounts_by_legal_entity(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_ats_accounts_by_legal_entity(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
            **kwargs,
        )
        if validate:
            return ATSAccountPydantic(**raw_response.body)
        return api_client.construct_model_instance(ATSAccountPydantic, raw_response.body)
    ...
    def list_ats_accounts_by_legal_entity(
        ...
        raw_response = self.raw.list_ats_accounts_by_legal_entity(
            legal_entity_id=legal_entity_id,
            continuation_token=continuation_token,
        )
        if validate:
