...
from paycor_python_sdk.model.tenant import Tenant as TenantSchema

from paycor_python_sdk.type.tenant import Tenant
from paycor_python_sdk.type.paycor_error import PaycorError

from ...api_client import Dictionary
from paycor_python_sdk.pydantic.tenant import Tenant as TenantPydantic
...
SchemaFor200ResponseBodyApplicationJson = TenantSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/tenants/{tenantId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return TenantPydantic(**raw_response.body)
        return api_client.construct_model_instance(TenantPydantic, raw_response.body)
