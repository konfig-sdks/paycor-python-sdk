...
from paycor_python_sdk.model.employee_status_update import EmployeeStatusUpdate as EmployeeStatusUpdateSchema
from paycor_python_sdk.model.employment_status import EmploymentStatus as EmploymentStatusSchema
from paycor_python_sdk.model.eligible_for_rehire import EligibleForRehire as EligibleForRehireSchema

from paycor_python_sdk.type.employment_status import EmploymentStatus
from paycor_python_sdk.type.employee_status_update import EmployeeStatusUpdate
...
from paycor_python_sdk.type.eligible_for_rehire import EligibleForRehire
...
from paycor_python_sdk.pydantic.employee_status_update import EmployeeStatusUpdate as EmployeeStatusUpdatePydantic
from paycor_python_sdk.pydantic.paycor_error import PaycorError as PaycorErrorPydantic
from paycor_python_sdk.pydantic.eligible_for_rehire import EligibleForRehire as EligibleForRehirePydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeStatusUpdateSchema


request_body_employee_status_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_status_data_mapped_args(
        self,
        effective_date: datetime,
        employee_status: EmploymentStatus,
        employee_id: str,
        employee_status_reason_id: typing.Optional[typing.Optional[str]] = None,
        eligible_for_rehire: typing.Optional[EligibleForRehire] = None,
        is_voluntary_by_employee: typing.Optional[typing.Optional[bool]] = None,
        ...
        if employee_status_reason_id is not None:
            _body["EmployeeStatusReasonId"] = employee_status_reason_id
        if eligible_for_rehire is not None:
            _body["EligibleForRehire"] = eligible_for_rehire
        if is_voluntary_by_employee is not None:
            _body["IsVoluntaryByEmployee"] = is_voluntary_by_employee
    ...
    async def _aupdate_status_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/status',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_status_update.serialize(body, content_type)
...
class UpdateStatusDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_status_data(
        self,
        effective_date: datetime,
        employee_status: EmploymentStatus,
        employee_id: str,
        ...
        **kwargs,
        ...
        args = self._update_status_data_mapped_args(
            effective_date=effective_date,
            employee_status=employee_status,
            employee_id=employee_id,
            employee_status_reason_id=employee_status_reason_id,
            eligible_for_rehire=eligible_for_rehire,
            is_voluntary_by_employee=is_voluntary_by_employee,
            notes=notes,
        )
        return await self._aupdate_status_data_oapg(
            body=args.body,
    ...
    def update_status_data(
        ...
        return self._update_status_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateStatusData(BaseApi):
    ...
    async def aupdate_status_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_status_data(
            effective_date=effective_date,
            employee_status=employee_status,
            employee_id=employee_id,
            employee_status_reason_id=employee_status_reason_id,
    ...
    def update_status_data(
        ...
        raw_response = self.raw.update_status_data(
            effective_date=effective_date,
            employee_status=employee_status,
            employee_id=employee_id,
            employee_status_reason_id=employee_status_reason_id,
