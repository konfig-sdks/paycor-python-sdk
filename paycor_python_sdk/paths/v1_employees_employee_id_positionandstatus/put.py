...
from paycor_python_sdk.model.employment_status2 import EmploymentStatus2 as EmploymentStatus2Schema
from paycor_python_sdk.model.employment_type import EmploymentType as EmploymentTypeSchema
from paycor_python_sdk.model.employee_position_and_status import EmployeePositionAndStatus as EmployeePositionAndStatusSchema
...
from paycor_python_sdk.type.employee_position_and_status import EmployeePositionAndStatus
...
from paycor_python_sdk.type.employment_status2 import EmploymentStatus2
...
from paycor_python_sdk.pydantic.employee_position_and_status import EmployeePositionAndStatus as EmployeePositionAndStatusPydantic
from paycor_python_sdk.pydantic.employment_status2 import EmploymentStatus2 as EmploymentStatus2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeePositionAndStatusSchema


request_body_employee_position_and_status = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_position_and_status_data_mapped_args(
        self,
        employment_status: EmploymentStatus2,
        ...
        manager_id: typing.Optional[typing.Optional[str]] = None,
        department_id: typing.Optional[typing.Optional[str]] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if employment_status is not None:
            _body["EmploymentStatus"] = employment_status
        if rehire_date is not None:
            _body["RehireDate"] = rehire_date
    ...
    async def _aupdate_position_and_status_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/employees/{employeeId}/positionandstatus',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_employee_position_and_status.serialize(body, content_type)
    ...
    def _update_position_and_status_data_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdatePositionAndStatusDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_position_and_status_data(
        self,
        employment_status: EmploymentStatus2,
        rehire_date: datetime,
        employment_type: EmploymentType,
        ...
        **kwargs,
        ...
        args = self._update_position_and_status_data_mapped_args(
        ...
        return await self._aupdate_position_and_status_data_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_position_and_status_data(
        self,
        employment_status: EmploymentStatus2,
        rehire_date: datetime,
        employment_type: EmploymentType,
        ...
        return self._update_position_and_status_data_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdatePositionAndStatusData(BaseApi):
    ...
    async def aupdate_position_and_status_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_position_and_status_data(
            employment_status=employment_status,
            rehire_date=rehire_date,
            employment_type=employment_type,
            work_location=work_location,
    ...
    def update_position_and_status_data(
        ...
        raw_response = self.raw.update_position_and_status_data(
            employment_status=employment_status,
            rehire_date=rehire_date,
            employment_type=employment_type,
            work_location=work_location,
