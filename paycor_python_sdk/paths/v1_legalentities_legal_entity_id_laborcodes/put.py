...
from paycor_python_sdk.model.labor_code5 import LaborCode5 as LaborCode5Schema

from paycor_python_sdk.type.labor_code5 import LaborCode5
...
from paycor_python_sdk.pydantic.labor_code5 import LaborCode5 as LaborCode5Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = LaborCode5Schema


request_body_labor_code5 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_specified_labor_code_mapped_args(
        self,
        labor_code_id: str,
        legal_entity_id: int,
        labor_code_name: typing.Optional[typing.Optional[str]] = None,
        ...
        _path_params = {}
        _body = {}
        if labor_code_id is not None:
            _body["LaborCodeId"] = labor_code_id
    ...
    async def _aupdate_specified_labor_code_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_labor_code5.serialize(body, content_type)
    ...
    def _update_specified_labor_code_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSpecifiedLaborCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specified_labor_code(
        self,
        labor_code_id: str,
        legal_entity_id: int,
        labor_code_name: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._update_specified_labor_code_mapped_args(
        ...
        return await self._aupdate_specified_labor_code_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_specified_labor_code(
        self,
        labor_code_id: str,
        legal_entity_id: int,
        labor_code_name: typing.Optional[typing.Optional[str]] = None,
        ...
        return self._update_specified_labor_code_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecifiedLaborCode(BaseApi):
    ...
    async def aupdate_specified_labor_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_specified_labor_code(
            labor_code_id=labor_code_id,
            legal_entity_id=legal_entity_id,
            labor_code_name=labor_code_name,
            description=description,
    ...
    def update_specified_labor_code(
        ...
        raw_response = self.raw.update_specified_labor_code(
            labor_code_id=labor_code_id,
            legal_entity_id=legal_entity_id,
            labor_code_name=labor_code_name,
            description=description,
