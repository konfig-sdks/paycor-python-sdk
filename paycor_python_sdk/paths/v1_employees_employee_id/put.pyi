...
from paycor_python_sdk.model.employee_contact import EmployeeContact as EmployeeContactSchema
...
from paycor_python_sdk.type.employee_contact import EmployeeContact
...
from paycor_python_sdk.pydantic.employee_contact import EmployeeContact as EmployeeContactPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeeContactSchema


request_body_employee_contact = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_contact_mapped_args(
        ...
        primary_address: typing.Optional[GenericAddress] = None,
    ...
    async def _aupdate_contact_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_employee_contact.serialize(body, content_type)
