...
class AccrualBalanceData(BaseModel):
    ...
    time_off_type_code: typing.Optional[typing.Optional[str]] = Field(None, alias='TimeOffTypeCode')

    # Determines what information to print on the payroll paystub (1.AvailableBalanceAndYTD,2.AvailableBalance,3.NoPrint)
    print_option: typing.Optional[typing.Optional[str]] = Field(None, alias='PrintOption')

    # Determines which payroll paystubs should be printed(1.AllPayStubs,2.RegularOnly,3.AdditionalOnly)
    payrun_types_to_include: typing.Optional[typing.Optional[str]] = Field(None, alias='PayrunTypesToInclude')

    # The number of days after an employee’s hire date before the balance is printed on the paystub
    print_delayin_days: typing.Optional[int] = Field(None, alias='PrintDelayinDays')

    # If there is a balance shortfall at the time of payroll (1.Warning,2.None,3.DoNotPay)
    shortfall_option: typing.Optional[typing.Optional[str]] = Field(None, alias='ShortfallOption')
    ...
    print_balance_paystub_option: typing.Optional[typing.Optional[str]] = Field(None, alias='PrintBalancePaystubOption')
    ...
    max_entitled_balance: typing.Optional[typing.Union[int, float]] = Field(None, alias='MaxEntitledBalance')

    # Hours remaining until maxEntitledBalance limit is reached
    remaining_entitled_balance: typing.Optional[typing.Union[int, float]] = Field(None, alias='RemainingEntitledBalance')
