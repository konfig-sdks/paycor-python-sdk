...
from paycor_python_sdk.pydantic.type_balance import TypeBalance
...
class EmployeeBalance(BaseModel):
    ...
    type_balances: typing.Optional[typing.Optional[typing.List[TypeBalance]]] = Field(None, alias='TypeBalances')
