...
from paycor_python_sdk.pydantic.relationship import Relationship
...
class EmergencyContact(BaseModel):
    ...
    relationship: typing.Optional[Relationship] = Field(None, alias='Relationship')
    ...
    work_phone_extension: typing.Optional[typing.Optional[str]] = Field(None, alias='WorkPhoneExtension')
