...
from paycor_python_sdk.pydantic.time_off_request_day import TimeOffRequestDay
...
class EmployeeTimeOffRequest(BaseModel):
    ...
    benefit_code: typing.Optional[typing.Optional[str]] = Field(None, alias='BenefitCode')
    ...
    days: typing.Optional[typing.Optional[typing.List[TimeOffRequestDay]]] = Field(None, alias='Days')
    ...
    status_update_time: typing.Optional[datetime] = Field(None, alias='StatusUpdateTime')

    # Unique identifier of employee who is updated status.
    status_update_by_employee_id: typing.Optional[str] = Field(None, alias='StatusUpdateByEmployeeId')

    # Unique identifier of employee who is created this time off request.
    created_by_employee_id: typing.Optional[str] = Field(None, alias='CreatedByEmployeeId')
