...
from paycor_python_sdk.pydantic.earning_type import EarningType
from paycor_python_sdk.pydantic.employee_earning_amount import EmployeeEarningAmount
from paycor_python_sdk.pydantic.include_in_pay import IncludeInPay
...
class EmployeeEarning(BaseModel):
    ...
    type: typing.Optional[EarningType] = Field(None, alias='Type')
    ...
    include_in_pay: typing.Optional[IncludeInPay] = Field(None, alias='IncludeInPay')
    ...
    amount_data: typing.Optional[typing.Optional[typing.List[EmployeeEarningAmount]]] = Field(None, alias='AmountData')

    employee: typing.Optional[ResourceReference] = Field(None, alias='Employee')

    legal_entity_earning: typing.Optional[ResourceReference] = Field(None, alias='LegalEntityEarning')
