...
from paycor_python_sdk.pydantic.employee_status_data2 import EmployeeStatusData2

class OnDemandPayDeductionInformation(BaseModel):
    ...
    pay_import_id: typing.Optional[int] = Field(None, alias='PayImportId')
    ...
    employee_number: typing.Optional[int] = Field(None, alias='EmployeeNumber')

    # First and last name of the employee.
    employee_name: typing.Optional[typing.Optional[str]] = Field(None, alias='EmployeeName')

    employee_status: typing.Optional[EmployeeStatusData2] = Field(None, alias='EmployeeStatus')

    # A flag that indicates that employee is paid.             
    was_employee_paid: typing.Optional[bool] = Field(None, alias='WasEmployeePaid')
    ...
    paid_amount: typing.Optional[typing.Union[int, float]] = Field(None, alias='PaidAmount')

    # Flag that shows information of shortfall amount.             
    shortfall_amount: typing.Optional[typing.Union[int, float]] = Field(None, alias='ShortfallAmount')

    # Flag that shows status information of payrun.
    payrun_status: typing.Optional[typing.Optional[str]] = Field(None, alias='PayrunStatus')

    # Flag that shows information of date of payrun process.
    payrun_process_date: typing.Optional[datetime] = Field(None, alias='PayrunProcessDate')
    ...
    impound_process_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='ImpoundProcessDate')

    # Unique number of impound reference.             
    impound_reference_id: typing.Optional[typing.Optional[str]] = Field(None, alias='ImpoundReferenceId')

    # Flag that shows information of impounded amount.             
    impounded_amount: typing.Optional[typing.Union[int, float]] = Field(None, alias='ImpoundedAmount')

    # Flag that shows is the client active or not in Paycor system.             
    is_client_active: typing.Optional[bool] = Field(None, alias='IsClientActive')
