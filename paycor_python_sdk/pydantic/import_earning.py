...
from paycor_python_sdk.pydantic.labor_code import LaborCode

class ImportEarning(BaseModel):
    ...
    business_start_date: datetime = Field(alias='BusinessStartDate')

    # Unique identifier of the pay group in Paycor's system. You can retrieve by calling 'Get Pay Groups by Legal Entity ID'
    pay_group_id: str = Field(alias='PayGroupId')

    # Number of hours that Employee worked.
    earning_hours: typing.Optional[typing.Union[int, float]] = Field(None, alias='EarningHours')

    # Dollar amount that Employee earned.
    earning_amount: typing.Optional[typing.Optional[typing.Union[int, float]]] = Field(None, alias='EarningAmount')

    # Dollar rate to assign to the earning. 
    earning_rate: typing.Optional[typing.Optional[typing.Union[int, float]]] = Field(None, alias='EarningRate')

    # End date of TimeCard
    business_end_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='BusinessEndDate')
    ...
    date_worked: typing.Optional[typing.Optional[datetime]] = Field(None, alias='DateWorked')

    # Optional. This allows supplying Labor Codes tied to this earning, used for Job Costing and other functionality. 
    labor_codes: typing.Optional[typing.Optional[typing.List[LaborCode]]] = Field(None, alias='LaborCodes')
    ...
    pay_number: typing.Optional[typing.Optional[int]] = Field(None, alias='PayNumber')

    # Optional. This field allows passing in additional information used by specific partner integrations.
    client_defined_value: typing.Optional[typing.Optional[str]] = Field(None, alias='ClientDefinedValue')
