...
class GeneralLedger(BaseModel):
    ...
    # Master Account 
    master_account: typing.Optional[typing.Optional[str]] = Field(None, alias='MasterAccount')
    ...
    itemize: typing.Optional[typing.Optional[bool]] = Field(None, alias='Itemize')

    # Sort sequence number
    sort_sequence: typing.Optional[typing.Optional[int]] = Field(None, alias='SortSequence')

    # Field that shows whether record is a credit (true) or debit (false)
    credit: typing.Optional[typing.Optional[bool]] = Field(None, alias='Credit')

    # String of 20 characters that represent company department number  Synonymous with CompanyOrganizationNumber
    company_department_number: typing.Optional[typing.Optional[str]] = Field(None, alias='CompanyDepartmentNumber')
