...
from paycor_python_sdk.pydantic.eligible_for_rehire import EligibleForRehire
...
class EmployeeStatusUpdate(BaseModel):
    ...
    employee_status: EmploymentStatus = Field(alias='EmployeeStatus')
    ...
    employee_status_reason_id: typing.Optional[typing.Optional[str]] = Field(None, alias='EmployeeStatusReasonId')

    eligible_for_rehire: typing.Optional[EligibleForRehire] = Field(None, alias='EligibleForRehire')
    ...
    is_voluntary_by_employee: typing.Optional[typing.Optional[bool]] = Field(None, alias='IsVoluntaryByEmployee')
