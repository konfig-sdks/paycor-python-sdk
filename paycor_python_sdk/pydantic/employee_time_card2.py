...
from paycor_python_sdk.pydantic.time_card_data import TimeCardData

class EmployeeTimeCard2(BaseModel):
    # Required freeform field for tracking purposes. You can input your company or application name.
    integration_vendor: str = Field(alias='IntegrationVendor')
    ...
    time_card_data: typing.List[TimeCardData] = Field(alias='TimeCardData')
