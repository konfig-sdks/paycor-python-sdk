...
class OnboardingEmployee(BaseModel):
    ...
    onboarding_employee_id: typing.Optional[str] = Field(None, alias='OnboardingEmployeeId')
    ...
    email_address: typing.Optional[typing.Optional[str]] = Field(None, alias='EmailAddress')

    # Date when employee was invited.
    invited_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='InvitedDate')

    # Indicates if this is invited or manual hiring.
    has_onboarding_access: typing.Optional[bool] = Field(None, alias='HasOnboardingAccess')

    # Date when the employee was hired.
    hire_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='HireDate')

    # Number of the total steps in the onboarding.
    steps_total: typing.Optional[typing.Optional[int]] = Field(None, alias='StepsTotal')

    # Number of the completed steps in the onboarding.
    steps_completed: typing.Optional[typing.Optional[int]] = Field(None, alias='StepsCompleted')

    # Last step that was completed by the employee.
    last_employee_step_completed: typing.Optional[int] = Field(None, alias='LastEmployeeStepCompleted')

    # Date when the last step was completed by employee.
    last_employee_step_completed_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='LastEmployeeStepCompletedDate')

    # Last step that was completed by the admin.
    last_admin_step_completed: typing.Optional[typing.Optional[int]] = Field(None, alias='LastAdminStepCompleted')

    # Date when the last step was completed by admin. 
    last_admin_step_completed_date: typing.Optional[typing.Optional[datetime]] = Field(None, alias='LastAdminStepCompletedDate')
    ...
    work_location_id: typing.Optional[typing.Optional[str]] = Field(None, alias='WorkLocationId')

    # Full name of the employees manager.
    manager: typing.Optional[typing.Optional[str]] = Field(None, alias='Manager')
