...
class Schedule2(BaseModel):
    ...
    before_start_time_in_minutes: typing.Optional[typing.Optional[int]] = Field(None, alias='BeforeStartTimeInMinutes')

    # Punches will be tied to the schedule if employee clocks out this many Minutes after shift ends.
    after_end_time_in_minutes: typing.Optional[typing.Optional[int]] = Field(None, alias='AfterEndTimeInMinutes')
    ...
    shift_depeartment_id: typing.Optional[typing.Optional[str]] = Field(None, alias='ShiftDepeartmentId')
