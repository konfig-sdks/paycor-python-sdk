...
from paycor_python_sdk.pydantic.employment_status_identifying_data import EmploymentStatusIdentifyingData

class EmployeesIdentifyingData(BaseModel):
    ...
    status: typing.Optional[EmploymentStatusIdentifyingData] = Field(None, alias='Status')
