...
from paycor_python_sdk.pydantic.import_employee import ImportEmployee

class ImportPayrollHours(BaseModel):
    ...
    import_employees: typing.List[ImportEmployee] = Field(alias='ImportEmployees')
