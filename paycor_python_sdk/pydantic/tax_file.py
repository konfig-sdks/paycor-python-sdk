...
class TaxFile(BaseModel):
    # Type of the report.
    report_type: typing.Optional[typing.Optional[str]] = Field(None, alias='ReportType')
    ...
    document_id: typing.Optional[typing.Optional[str]] = Field(None, alias='DocumentId')
    ...
    # Name of the report.
    report_name: typing.Optional[typing.Optional[str]] = Field(None, alias='ReportName')

    # Name of the tax document.
    file_name: typing.Optional[typing.Optional[str]] = Field(None, alias='FileName')

    tax_document_u_r_l: typing.Optional[ResourceReference] = Field(None, alias='TaxDocumentURL')
