...
from paycor_python_sdk.pydantic.legal_entity_address_type import LegalEntityAddressType
...
class LegalEntityAddress(BaseModel):
    ...
    type: typing.Optional[LegalEntityAddressType] = Field(None, alias='Type')
