...
class Schedule(BaseModel):
    ...
    schedule_id: typing.Optional[str] = Field(None, alias='ScheduleId')
    ...
    before_start_time_in_minutes: typing.Optional[int] = Field(None, alias='BeforeStartTimeInMinutes')

    # Punches will be tied to the schedule if employee clocks out this many Minutes after shift ends.
    after_end_time_in_minutes: typing.Optional[int] = Field(None, alias='AfterEndTimeInMinutes')

    # Department name where the employee's timecard was created.
    shift_department_name: typing.Optional[typing.Optional[str]] = Field(None, alias='ShiftDepartmentName')

    # This is the shift name that is associated to the shift.
    shift_name: typing.Optional[typing.Optional[str]] = Field(None, alias='ShiftName')

    # This is the amount of minutes an employee has worked.
    total_minutes_worked: typing.Optional[int] = Field(None, alias='TotalMinutesWorked')
    ...
    start_date_time_with_before: typing.Optional[datetime] = Field(None, alias='StartDateTimeWithBefore')

    # Date and time when employee punches will stop being tied to a schedule. Format: YYYY-MM-DDTHH:MM:SSZ  (ISO-8601 standard)             
    end_date_time_with_after: typing.Optional[datetime] = Field(None, alias='EndDateTimeWithAfter')

    # True if shift starts in one day and ends the next day.
    crosses_midnight: typing.Optional[bool] = Field(None, alias='CrossesMidnight')

    shift_department: typing.Optional[ResourceReference] = Field(None, alias='ShiftDepartment')
