...
class SimpleHire(BaseModel):
    ...
    home_email_address: str = Field(alias='HomeEmailAddress')

    # Email of the user exporting records
    exported_by_email_address: typing.Optional[typing.Optional[str]] = Field(None, alias='ExportedByEmailAddress')

    # Preferred Name of the Person             
    preferred_name: typing.Optional[typing.Optional[str]] = Field(None, alias='PreferredName')
    ...
    veteran_status: typing.Optional[VeteranStatus] = Field(None, alias='VeteranStatus')
    ...
    department_code: typing.Optional[typing.Optional[str]] = Field(None, alias='DepartmentCode')

    disability: typing.Optional[DisabilityStatus] = Field(None, alias='Disability')

    # Base Salary of new hire employee
    base_salary: typing.Optional[typing.Optional[typing.Union[int, float]]] = Field(None, alias='BaseSalary')

    # Salary Frequency of new hire employee
    salary_frequency: typing.Optional[typing.Optional[str]] = Field(None, alias='SalaryFrequency')
