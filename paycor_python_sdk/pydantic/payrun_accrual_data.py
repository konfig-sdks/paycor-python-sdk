...
from paycor_python_sdk.pydantic.employee_payroll_hours import EmployeePayrollHours

class PayrunAccrualData(BaseModel):
    ...
    employee_payroll_hours: typing.Optional[typing.Optional[typing.List[EmployeePayrollHours]]] = Field(None, alias='EmployeePayrollHours')
