...
class RequiredEmployeeTimeCard2(TypedDict):
    ...
    TimeCardData: typing.List[TimeCardData]

class OptionalEmployeeTimeCard2(TypedDict, total=False):
...
class EmployeeTimeCard2(RequiredEmployeeTimeCard2, OptionalEmployeeTimeCard2):
    pass
