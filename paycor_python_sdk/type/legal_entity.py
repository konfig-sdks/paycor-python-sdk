...
from paycor_python_sdk.type.business_name import BusinessName
from paycor_python_sdk.type.corporation_type import CorporationType
from paycor_python_sdk.type.resource_reference import ResourceReference

class RequiredLegalEntity(TypedDict):
    pass

class OptionalLegalEntity(TypedDict, total=False):
    ...
    BusinessNames: typing.Optional[typing.List[BusinessName]]

    Tenant: ResourceReference

    Employees: ResourceReference

    Persons: ResourceReference
...
class LegalEntity(RequiredLegalEntity, OptionalLegalEntity):
    pass
