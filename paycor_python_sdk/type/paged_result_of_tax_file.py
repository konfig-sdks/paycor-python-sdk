...
from paycor_python_sdk.type.tax_file import TaxFile

class RequiredPagedResultOfTaxFile(TypedDict):
    pass

class OptionalPagedResultOfTaxFile(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[TaxFile]]

class PagedResultOfTaxFile(RequiredPagedResultOfTaxFile, OptionalPagedResultOfTaxFile):
    pass
