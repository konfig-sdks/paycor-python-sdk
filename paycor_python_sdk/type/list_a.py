...
from paycor_python_sdk.type.list_a_document import ListADocument

class RequiredListA(TypedDict):
    pass

class OptionalListA(TypedDict, total=False):
    DocumentTitle: ListADocument
