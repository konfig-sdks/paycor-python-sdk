...
from paycor_python_sdk.type.labor_code_v2 import LaborCodeV2

class RequiredTimeCardV3(TypedDict):
    pass

class OptionalTimeCardV3(TypedDict, total=False):
    ...
    BadgeNumber: typing.Optional[int]
    ...
    EstimatedGrossPay: typing.Optional[typing.Union[int, float]]

    # List of type LaborCode containing the employee's labor code information.             
    LaborCodes: typing.Optional[typing.List[LaborCodeV2]]

class TimeCardV3(RequiredTimeCardV3, OptionalTimeCardV3):
    pass
