...
from paycor_python_sdk.type.work_site import WorkSite

class RequiredPagedResultOfWorkSite(TypedDict):
    pass

class OptionalPagedResultOfWorkSite(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[WorkSite]]

class PagedResultOfWorkSite(RequiredPagedResultOfWorkSite, OptionalPagedResultOfWorkSite):
    pass
