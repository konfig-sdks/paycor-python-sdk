...
class RequiredEmployeeDirectDeposit(TypedDict):
    pass

class OptionalEmployeeDirectDeposit(TypedDict, total=False):
    ...
    MaskedAccountNumber: typing.Optional[str]

    # The bank routing number where the direct deposit is directed.              
    RoutingNumber: typing.Optional[str]
...
class EmployeeDirectDeposit(RequiredEmployeeDirectDeposit, OptionalEmployeeDirectDeposit):
    pass
