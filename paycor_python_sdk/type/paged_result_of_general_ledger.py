...
from paycor_python_sdk.type.general_ledger import GeneralLedger

class RequiredPagedResultOfGeneralLedger(TypedDict):
    pass

class OptionalPagedResultOfGeneralLedger(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[GeneralLedger]]

class PagedResultOfGeneralLedger(RequiredPagedResultOfGeneralLedger, OptionalPagedResultOfGeneralLedger):
    pass
