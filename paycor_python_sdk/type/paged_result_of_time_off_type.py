...
from paycor_python_sdk.type.time_off_type import TimeOffType

class RequiredPagedResultOfTimeOffType(TypedDict):
    pass

class OptionalPagedResultOfTimeOffType(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[TimeOffType]]

class PagedResultOfTimeOffType(RequiredPagedResultOfTimeOffType, OptionalPagedResultOfTimeOffType):
    pass
