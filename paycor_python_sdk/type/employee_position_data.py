...
from paycor_python_sdk.type.manager import Manager

class RequiredEmployeePositionData(TypedDict):
    pass

class OptionalEmployeePositionData(TypedDict, total=False):
...
class EmployeePositionData(RequiredEmployeePositionData, OptionalEmployeePositionData):
    pass
