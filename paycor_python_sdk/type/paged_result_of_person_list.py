...
from paycor_python_sdk.type.person_list import PersonList

class RequiredPagedResultOfPersonList(TypedDict):
    pass

class OptionalPagedResultOfPersonList(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PersonList]]

class PagedResultOfPersonList(RequiredPagedResultOfPersonList, OptionalPagedResultOfPersonList):
    pass
