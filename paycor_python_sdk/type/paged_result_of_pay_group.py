...
from paycor_python_sdk.type.pay_group import PayGroup

class RequiredPagedResultOfPayGroup(TypedDict):
    pass

class OptionalPagedResultOfPayGroup(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayGroup]]

class PagedResultOfPayGroup(RequiredPagedResultOfPayGroup, OptionalPagedResultOfPayGroup):
    pass
