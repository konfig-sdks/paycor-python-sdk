...
from paycor_python_sdk.type.labor_code2 import LaborCode2

class RequiredTimeCard(TypedDict):
    pass

class OptionalTimeCard(TypedDict, total=False):
    ...
    LaborCodes: typing.Optional[typing.List[LaborCode2]]

class TimeCard(RequiredTimeCard, OptionalTimeCard):
    pass
