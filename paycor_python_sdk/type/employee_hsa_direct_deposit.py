...
class RequiredEmployeeHsaDirectDeposit(TypedDict):
...
class OptionalEmployeeHsaDirectDeposit(TypedDict, total=False):
...
class EmployeeHsaDirectDeposit(RequiredEmployeeHsaDirectDeposit, OptionalEmployeeHsaDirectDeposit):
    pass
