...
class RequiredEmployeePayRate3(TypedDict):
...
class OptionalEmployeePayRate3(TypedDict, total=False):
...
class EmployeePayRate3(RequiredEmployeePayRate3, OptionalEmployeePayRate3):
    pass
