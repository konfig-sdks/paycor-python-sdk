...
class RequiredPagedResultOfEmployeeTimeOffRequest(TypedDict):
    pass

class OptionalPagedResultOfEmployeeTimeOffRequest(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[EmployeeTimeOffRequest]]

class PagedResultOfEmployeeTimeOffRequest(RequiredPagedResultOfEmployeeTimeOffRequest, OptionalPagedResultOfEmployeeTimeOffRequest):
    pass
