...
class RequiredEmployeePayRate2(TypedDict):
...
class OptionalEmployeePayRate2(TypedDict, total=False):
...
class EmployeePayRate2(RequiredEmployeePayRate2, OptionalEmployeePayRate2):
    pass
