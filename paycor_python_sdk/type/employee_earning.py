...
from paycor_python_sdk.type.earning_type import EarningType
...
class RequiredEmployeeEarning(TypedDict):
    pass

class OptionalEmployeeEarning(TypedDict, total=False):
    ...
    SequenceNumber: typing.Optional[int]
    ...
    AmountData: typing.Optional[typing.List[EmployeeEarningAmount]]

    Employee: ResourceReference

    LegalEntityEarning: ResourceReference

class EmployeeEarning(RequiredEmployeeEarning, OptionalEmployeeEarning):
    pass
