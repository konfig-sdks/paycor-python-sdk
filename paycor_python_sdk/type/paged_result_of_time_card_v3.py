...
from paycor_python_sdk.type.time_card_v3 import TimeCardV3

class RequiredPagedResultOfTimeCardV3(TypedDict):
    pass

class OptionalPagedResultOfTimeCardV3(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[TimeCardV3]]

class PagedResultOfTimeCardV3(RequiredPagedResultOfTimeCardV3, OptionalPagedResultOfTimeCardV3):
    pass
