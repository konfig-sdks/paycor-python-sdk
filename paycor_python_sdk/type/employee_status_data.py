...
class RequiredEmployeeStatusData(TypedDict):
    pass

class OptionalEmployeeStatusData(TypedDict, total=False):
...
class EmployeeStatusData(RequiredEmployeeStatusData, OptionalEmployeeStatusData):
    pass
