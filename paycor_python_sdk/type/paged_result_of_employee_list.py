...
from paycor_python_sdk.type.employee_list import EmployeeList

class RequiredPagedResultOfEmployeeList(TypedDict):
    pass

class OptionalPagedResultOfEmployeeList(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[EmployeeList]]

class PagedResultOfEmployeeList(RequiredPagedResultOfEmployeeList, OptionalPagedResultOfEmployeeList):
    pass
