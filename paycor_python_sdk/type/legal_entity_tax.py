...
from paycor_python_sdk.type.deposit_frequency_type import DepositFrequencyType
...
from paycor_python_sdk.type.tax_type import TaxType

class RequiredLegalEntityTax(TypedDict):
    pass

class OptionalLegalEntityTax(TypedDict, total=False):
    ...
    # Tax authority code
    TaxAuthCode: typing.Optional[str]
    ...
    OfferDependentInsurance: typing.Optional[bool]

    # Wage plan             
    WagePlan: typing.Optional[str]

    # Specifies Item hold status on the tax Specifies tax status
    ItemHold: typing.Optional[str]

    LegalEntity: ResourceReference

class LegalEntityTax(RequiredLegalEntityTax, OptionalLegalEntityTax):
    pass
