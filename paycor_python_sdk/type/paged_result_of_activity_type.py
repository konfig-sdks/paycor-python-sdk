...
from paycor_python_sdk.type.activity_type import ActivityType

class RequiredPagedResultOfActivityType(TypedDict):
    pass

class OptionalPagedResultOfActivityType(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[ActivityType]]

class PagedResultOfActivityType(RequiredPagedResultOfActivityType, OptionalPagedResultOfActivityType):
    pass
