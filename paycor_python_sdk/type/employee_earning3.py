...
class RequiredEmployeeEarning3(TypedDict):
...
class OptionalEmployeeEarning3(TypedDict, total=False):
...
class EmployeeEarning3(RequiredEmployeeEarning3, OptionalEmployeeEarning3):
    pass
