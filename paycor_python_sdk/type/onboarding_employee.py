...
class RequiredOnboardingEmployee(TypedDict):
    pass

class OptionalOnboardingEmployee(TypedDict, total=False):
...
class OnboardingEmployee(RequiredOnboardingEmployee, OptionalOnboardingEmployee):
    pass
