...
from paycor_python_sdk.type.job_costing import JobCosting

class RequiredPagedResultOfJobCosting(TypedDict):
    pass

class OptionalPagedResultOfJobCosting(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[JobCosting]]

class PagedResultOfJobCosting(RequiredPagedResultOfJobCosting, OptionalPagedResultOfJobCosting):
    pass
