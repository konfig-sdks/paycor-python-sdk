...
from paycor_python_sdk.type.report_builder import ReportBuilder

class RequiredPagedResultOfReportBuilder(TypedDict):
    pass

class OptionalPagedResultOfReportBuilder(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[ReportBuilder]]

class PagedResultOfReportBuilder(RequiredPagedResultOfReportBuilder, OptionalPagedResultOfReportBuilder):
    pass
