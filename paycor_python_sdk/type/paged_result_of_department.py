...
class RequiredPagedResultOfDepartment(TypedDict):
    pass

class OptionalPagedResultOfDepartment(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[Department]]

class PagedResultOfDepartment(RequiredPagedResultOfDepartment, OptionalPagedResultOfDepartment):
    pass
