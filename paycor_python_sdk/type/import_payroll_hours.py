...
class RequiredImportPayrollHours(TypedDict):
    ...
    ImportEmployees: typing.List[ImportEmployee]

class OptionalImportPayrollHours(TypedDict, total=False):
    pass

class ImportPayrollHours(RequiredImportPayrollHours, OptionalImportPayrollHours):
    pass
