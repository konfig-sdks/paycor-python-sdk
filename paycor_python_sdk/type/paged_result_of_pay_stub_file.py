...
from paycor_python_sdk.type.pay_stub_file import PayStubFile

class RequiredPagedResultOfPayStubFile(TypedDict):
    pass

class OptionalPagedResultOfPayStubFile(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayStubFile]]

class PagedResultOfPayStubFile(RequiredPagedResultOfPayStubFile, OptionalPagedResultOfPayStubFile):
    pass
