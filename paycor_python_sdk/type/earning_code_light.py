...
class RequiredEarningCodeLight(TypedDict):
    pass

class OptionalEarningCodeLight(TypedDict, total=False):
...
class EarningCodeLight(RequiredEarningCodeLight, OptionalEarningCodeLight):
    pass
