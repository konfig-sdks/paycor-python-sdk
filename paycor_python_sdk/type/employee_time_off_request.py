...
from paycor_python_sdk.type.time_off_request_day import TimeOffRequestDay

class RequiredEmployeeTimeOffRequest(TypedDict):
    pass

class OptionalEmployeeTimeOffRequest(TypedDict, total=False):
    LegalEntityId: int

    # Unique identifier of this time off request.
    TimeOffRequestId: str

    BenefitCode: typing.Optional[str]
    ...
    Days: typing.Optional[typing.List[TimeOffRequestDay]]
...
class EmployeeTimeOffRequest(RequiredEmployeeTimeOffRequest, OptionalEmployeeTimeOffRequest):
    pass
