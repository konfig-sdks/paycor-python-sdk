...
from paycor_python_sdk.type.tenant_job_title import TenantJobTitle

class RequiredPagedResultOfTenantJobTitle(TypedDict):
    pass

class OptionalPagedResultOfTenantJobTitle(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[TenantJobTitle]]

class PagedResultOfTenantJobTitle(RequiredPagedResultOfTenantJobTitle, OptionalPagedResultOfTenantJobTitle):
    pass
