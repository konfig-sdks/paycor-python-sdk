...
from paycor_python_sdk.type.employee_status_data2 import EmployeeStatusData2

class RequiredOnDemandPayDeductionInformation(TypedDict):
    pass

class OptionalOnDemandPayDeductionInformation(TypedDict, total=False):
    ...
    EmployeeStatus: EmployeeStatusData2

    # A flag that indicates that employee is paid.             
    WasEmployeePaid: bool
    ...
    ImpoundProcessDate: typing.Optional[datetime]

    # Unique number of impound reference.             
    ImpoundReferenceId: typing.Optional[str]

    # Flag that shows information of impounded amount.             
    ImpoundedAmount: typing.Union[int, float]

    # Flag that shows is the client active or not in Paycor system.             
    IsClientActive: bool

class OnDemandPayDeductionInformation(RequiredOnDemandPayDeductionInformation, OptionalOnDemandPayDeductionInformation):
    pass
