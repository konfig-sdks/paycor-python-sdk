...
from paycor_python_sdk.type.labor_code import LaborCode

class RequiredImportEarning(TypedDict):
...
class OptionalImportEarning(TypedDict, total=False):
    # Number of hours that Employee worked.
    EarningHours: typing.Union[int, float]

    # Dollar amount that Employee earned.
    EarningAmount: typing.Optional[typing.Union[int, float]]

    # Dollar rate to assign to the earning. 
    EarningRate: typing.Optional[typing.Union[int, float]]

    # End date of TimeCard
    BusinessEndDate: typing.Optional[datetime]
    ...
    PayNumber: typing.Optional[int]

    # Optional. This field allows passing in additional information used by specific partner integrations.
    ClientDefinedValue: typing.Optional[str]

class ImportEarning(RequiredImportEarning, OptionalImportEarning):
    pass
