...
class RequiredSchedule2(TypedDict):
    pass

class OptionalSchedule2(TypedDict, total=False):
    ...
    ShiftDepeartmentId: typing.Optional[str]

class Schedule2(RequiredSchedule2, OptionalSchedule2):
    pass
