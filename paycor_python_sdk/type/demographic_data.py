...
class RequiredDemographicData(TypedDict):
    pass

class OptionalDemographicData(TypedDict, total=False):
    ...
    MaidenName: typing.Optional[str]

class DemographicData(RequiredDemographicData, OptionalDemographicData):
    pass
