...
from paycor_python_sdk.type.pay_period2 import PayPeriod2

class RequiredPagedResultOfPayPeriod2(TypedDict):
    pass

class OptionalPagedResultOfPayPeriod2(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayPeriod2]]

class PagedResultOfPayPeriod2(RequiredPagedResultOfPayPeriod2, OptionalPagedResultOfPayPeriod2):
    pass
