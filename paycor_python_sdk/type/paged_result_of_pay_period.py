...
from paycor_python_sdk.type.pay_period import PayPeriod

class RequiredPagedResultOfPayPeriod(TypedDict):
    pass

class OptionalPagedResultOfPayPeriod(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayPeriod]]

class PagedResultOfPayPeriod(RequiredPagedResultOfPayPeriod, OptionalPagedResultOfPayPeriod):
    pass
