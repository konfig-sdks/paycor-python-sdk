...
class RequiredEmployeeContact(TypedDict):
    pass

class OptionalEmployeeContact(TypedDict, total=False):
...
class EmployeeContact(RequiredEmployeeContact, OptionalEmployeeContact):
    pass
