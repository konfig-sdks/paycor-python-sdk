...
class RequiredEmployeeHsaDirectDeposit2(TypedDict):
...
class OptionalEmployeeHsaDirectDeposit2(TypedDict, total=False):
...
class EmployeeHsaDirectDeposit2(RequiredEmployeeHsaDirectDeposit2, OptionalEmployeeHsaDirectDeposit2):
    pass
