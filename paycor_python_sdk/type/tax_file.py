...
class RequiredTaxFile(TypedDict):
    pass

class OptionalTaxFile(TypedDict, total=False):
    # Type of the report.
    ReportType: typing.Optional[str]
    ...
    DocumentId: typing.Optional[str]
    ...
    TaxDocumentURL: ResourceReference

class TaxFile(RequiredTaxFile, OptionalTaxFile):
    pass
