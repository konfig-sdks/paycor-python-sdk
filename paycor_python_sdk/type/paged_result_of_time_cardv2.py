...
from paycor_python_sdk.type.time_cardv2 import TimeCardv2

class RequiredPagedResultOfTimeCardv2(TypedDict):
    pass

class OptionalPagedResultOfTimeCardv2(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[TimeCardv2]]

class PagedResultOfTimeCardv2(RequiredPagedResultOfTimeCardv2, OptionalPagedResultOfTimeCardv2):
    pass
