...
from paycor_python_sdk.type.schedule_group import ScheduleGroup

class RequiredPagedResultOfScheduleGroup(TypedDict):
    pass

class OptionalPagedResultOfScheduleGroup(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[ScheduleGroup]]

class PagedResultOfScheduleGroup(RequiredPagedResultOfScheduleGroup, OptionalPagedResultOfScheduleGroup):
    pass
