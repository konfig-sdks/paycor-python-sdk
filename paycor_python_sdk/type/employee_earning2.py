...
class RequiredEmployeeEarning2(TypedDict):
    ...
    AmountData: typing.List[EmployeeEarningAmount]

class OptionalEmployeeEarning2(TypedDict, total=False):
...
class EmployeeEarning2(RequiredEmployeeEarning2, OptionalEmployeeEarning2):
    pass
