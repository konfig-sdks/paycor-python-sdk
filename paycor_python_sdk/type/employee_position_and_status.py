...
class RequiredEmployeePositionAndStatus(TypedDict):
...
class OptionalEmployeePositionAndStatus(TypedDict, total=False):
...
class EmployeePositionAndStatus(RequiredEmployeePositionAndStatus, OptionalEmployeePositionAndStatus):
    pass
