...
class RequiredEmployeePayRate(TypedDict):
    pass

class OptionalEmployeePayRate(TypedDict, total=False):
    ...
    PayRate: typing.Optional[typing.Union[int, float]]

    # Employee's annual amount of pay (in dollars).             
    AnnualPayRate: typing.Optional[typing.Union[int, float]]
...
class EmployeePayRate(RequiredEmployeePayRate, OptionalEmployeePayRate):
    pass
