...
class RequiredEmployeeDeductionAmount3(TypedDict):
    # Date the employee deduction rates and amounts take effect. Format: YYYY-MM-DDTHH:MM:SSZ  (ISO-8601 standard)              
    EffectiveStartDate: datetime

class OptionalEmployeeDeductionAmount3(TypedDict, total=False):
...
class EmployeeDeductionAmount3(RequiredEmployeeDeductionAmount3, OptionalEmployeeDeductionAmount3):
    pass
