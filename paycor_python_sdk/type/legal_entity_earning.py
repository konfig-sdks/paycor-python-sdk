...
class RequiredLegalEntityEarning(TypedDict):
    pass

class OptionalLegalEntityEarning(TypedDict, total=False):
    ...
    Hours: typing.Optional[typing.Union[int, float]]
...
class LegalEntityEarning(RequiredLegalEntityEarning, OptionalLegalEntityEarning):
    pass
