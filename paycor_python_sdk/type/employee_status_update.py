...
class RequiredEmployeeStatusUpdate(TypedDict):
...
class OptionalEmployeeStatusUpdate(TypedDict, total=False):
    ...
    EmployeeStatusReasonId: typing.Optional[str]
    ...
    IsVoluntaryByEmployee: typing.Optional[bool]

    # Notes associated with the employee's status update, which will be stored in Employee's Status History.             
    Notes: typing.Optional[str]

class EmployeeStatusUpdate(RequiredEmployeeStatusUpdate, OptionalEmployeeStatusUpdate):
    pass
