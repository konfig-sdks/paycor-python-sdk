...
class RequiredSimpleHire(TypedDict):
    # Legal Entity Id
    LegalEntityId: int
    ...
    HomeEmailAddress: str

class OptionalSimpleHire(TypedDict, total=False):
    # Email of the user exporting records
    ExportedByEmailAddress: typing.Optional[str]

    # Preferred Name of the Person             
    PreferredName: typing.Optional[str]
    ...
    DepartmentCode: typing.Optional[str]

    Disability: DisabilityStatus

    # Base Salary of new hire employee
    BaseSalary: typing.Optional[typing.Union[int, float]]

    # Salary Frequency of new hire employee
    SalaryFrequency: typing.Optional[str]

    # Worklocation Id of new hire employee
    WorkLocationId: typing.Optional[str]

class SimpleHire(RequiredSimpleHire, OptionalSimpleHire):
    pass
