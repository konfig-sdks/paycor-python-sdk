...
class RequiredPagedResultOfPerson(TypedDict):
    pass

class OptionalPagedResultOfPerson(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[Person]]

class PagedResultOfPerson(RequiredPagedResultOfPerson, OptionalPagedResultOfPerson):
    pass
