...
class RequiredPagedResultOfJob(TypedDict):
    pass

class OptionalPagedResultOfJob(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[Job]]

class PagedResultOfJob(RequiredPagedResultOfJob, OptionalPagedResultOfJob):
    pass
