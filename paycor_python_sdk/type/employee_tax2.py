...
class RequiredEmployeeTax2(TypedDict):
    ...
    WithholdingEffectiveStartDate: datetime

class OptionalEmployeeTax2(TypedDict, total=False):
...
class EmployeeTax2(RequiredEmployeeTax2, OptionalEmployeeTax2):
    pass
