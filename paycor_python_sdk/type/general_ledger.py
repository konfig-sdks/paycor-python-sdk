...
class RequiredGeneralLedger(TypedDict):
    pass

class OptionalGeneralLedger(TypedDict, total=False):
    ...
    # Master Account 
    MasterAccount: typing.Optional[str]
...
class GeneralLedger(RequiredGeneralLedger, OptionalGeneralLedger):
    pass
