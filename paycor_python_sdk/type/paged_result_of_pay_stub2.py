...
from paycor_python_sdk.type.pay_stub2 import PayStub2

class RequiredPagedResultOfPayStub2(TypedDict):
    pass

class OptionalPagedResultOfPayStub2(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayStub2]]

class PagedResultOfPayStub2(RequiredPagedResultOfPayStub2, OptionalPagedResultOfPayStub2):
    pass
