...
from paycor_python_sdk.type.pay_stub import PayStub

class RequiredPagedResultOfPayStub(TypedDict):
    pass

class OptionalPagedResultOfPayStub(TypedDict, total=False):
    ...
    Records: typing.Optional[typing.List[PayStub]]

class PagedResultOfPayStub(RequiredPagedResultOfPayStub, OptionalPagedResultOfPayStub):
    pass
