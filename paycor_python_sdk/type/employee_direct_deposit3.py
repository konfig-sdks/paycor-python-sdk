...
class RequiredEmployeeDirectDeposit3(TypedDict):
...
class OptionalEmployeeDirectDeposit3(TypedDict, total=False):
...
class EmployeeDirectDeposit3(RequiredEmployeeDirectDeposit3, OptionalEmployeeDirectDeposit3):
    pass
