...
from paycor_python_sdk.exceptions_base import ApiValueError
from paycor_python_sdk.exceptions import ClientConfigurationError
...
conf = paycor_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://apis.paycor.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if access_token:
            self.api_key['Access-Token'] = access_token
        if apim_subscription_key:
            self.api_key['Apim-Subscription-Key'] = apim_subscription_key
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("paycor_python_sdk")
    ...
    def auth_settings(self):
        ...
        if 'Apim-Subscription-Key' in self.api_key:
